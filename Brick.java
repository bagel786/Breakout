...
public class Brick {
    ...
    private int points;
    private Random rand;
    private final int WIDTH = 50; // capitalized because it is a contant, final means it is a constant, does not change, must be assigned when it is defined
    private final int HEIGHT = 25; // also a constant variable
    ...
    */
    ...
    public Brick(Breakout b, int x, int y, Color c) { // b is the initial Breakout object , extra parameters give the x, y, and color position
